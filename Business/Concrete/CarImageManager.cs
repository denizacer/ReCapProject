...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        private IDataResult<CarImage> CreatedFile(CarImage carImage, string extension)
        {
            ...
            return new SuccessDataResult<CarImage>(new CarImage { CarImageId = carImage.CarImageId, CarId = carImage.CarId, ImagePath = result, Date = DateTime.Now }, Messages.CarAdded);
        }
        ...
        private IResult CheckIfImageLimit(int carid)
        {
            ...
            // return new SuccessResult((Messages.okctrl));
            return new SuccesResult((Messages.CarDeleted));
        }
    }
}
